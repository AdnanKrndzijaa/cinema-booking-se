  ...
  return (
    <div>
			...
			<div className='h-[100vh] flex flex-col relative z-10'>
				...
				<div className='flex flex-1 items-center'>
					<div className='w-full sm:w-5/6 m:w-4/6 flex flex-col'>
						<h1 className='text-[36px] ss:text-[42px] sm:text-[46px] text-white mb-[24px]'>{data?.title}</h1>
						<p className='text-text mb-[40px]'>{data?.description}</p>
						<div className='flex flex-col xs:flex-row gap-[12px]'>
							<Button 
							type="primary"
							label="Buy Tickets"
							/>
							...
							label="Watch Trailer"
							/>
							<button className='flex border-white w-[58px] items-center justify-center border-[1px] rounded-[10px] aspect-square'>
		...
		<div className='flex flex-col ss:flex-row px-[9.5vw]'>
			<div className='w-full ss:w-2/6 ss:pr-[60px] m:pr-[110px]'>
			...
			<div className='w-full ss:w-4/6'>
				...
				<div className='mb-[60px]'>
					...
					<div className='grid grid-cols-4 py-[20px] border-b-[1px] border-primaryvariant1'>
						...
						<div className='flex gap-[8px] col-span-3 ml-[12px]'>
							{data?.genre.map((item) => (
								<Genre title={item}/>
							))}
						</div>
					...
					<div className='grid grid-cols-4 py-[20px] border-b-[1px] border-primaryvariant1'>
						...
						<p className='text-white ml-[12px]'>{data?.duration}</p>
					</div>
					<div className='grid grid-cols-4 py-[20px] border-b-[1px] border-primaryvariant1 '>
						<h6 className='text-white'>Release Year</h6>
						<p className='text-white ml-[12px]'>{data?.releaseYear}</p>
					</div>
					<div className='grid grid-cols-4 py-[20px] border-b-[1px] border-primaryvariant1'>
						<h6 className='text-white'>Writers</h6>
						<div className='flex gap-[8px] ml-[12px] col-span-3'>
				...
				<div className='mb-[60px]'>
					...
					<div className='grid grid-cols-4 gap-[28px]'>
						{data?.galleryImages.map((image) =>(
							<img className='rounded-[10px] h-[100px] w-full object-cover' src={image}></img>
						))}
					</div>
				</div>
