...
const Search: React.FC<InputProps> = ({
    ...
    return (
        <div className="inputwcontrol flex w-full bg-primaryvariant1 rounded-[10px] items-center pl-[16px] focus:outline-[1px] focus:outline-white focus:shadow-[0_0_15px_rgba(255,255,255,0.2)]">
            <span>
