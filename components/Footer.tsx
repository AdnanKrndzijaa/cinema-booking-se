...
const Footer = () => {
  return (
    <div className='mt-[160px] mb-[60px]'>
        <div className='flex mb-[36px] gap-[60px]'>
            <div>
                <svg className='mb-[36px]' id="Logo" xmlns="http://www.w3.org/2000/svg" width="157.243" height="35.94" viewBox="0 0 157.243 35.94">
                ...
                <p className='text-text'>Cinema Tickets offers a quick and easy way to book tickets online for current and upcoming movie releases across cities in Bosnia and Herzegovina. </p>
            </div>
            <div>
                <h5 className='text-white text-[20px]'>Get the App</h5>
            </div>
        </div>
        <div className='flex gap-[40px] mb-[60px]'>
            <a className='text-white font-medium' href="">Dashboard</a>
            <a className='text-white font-medium' href="">Events</a>
            <a className='text-white font-medium' href="">Membership</a>
            <a className='text-white font-medium' href="">Help</a>
            <a className='text-white font-medium' href="">Privacy</a>
        </div>
        ...
        <div className='flex justify-between'>
            ...
            <div className='flex gap-[40px]'>
                <a className='text-text' href="">Terms of use</a>
